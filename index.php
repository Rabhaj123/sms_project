  ...
  <section class="py-5">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6" style="background:url(./image/img\ \(3\).jpeg)">
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 mb-4">
          <div class="card">
            <div>
              <img src="./image/cc (1).jpeg" alt="" class="img-fluid rounded-top course-image">
            </div>
            <div class="card-body">
         ...
         <div class="col-lg-3 mb-4">
          <div class="card">
            <div>
              <img src="./image/cc (3).jpeg" alt="" class="img-fluid rounded-top course-image">
            </div>
            <div class="card-body">
         ...
         <div class="col-lg-3 mb-4">
          <div class="card">
            <div>
              <img src="./image/cc (1).webp" alt="" class="img-fluid rounded-top course-image">
            </div>
            <div class="card-body">
         ...
         <div class="col-lg-3 mb-4">
          <div class="card">
            <div>
              <img src="./image/cc (2).jpeg" alt="" class="img-fluid rounded-top course-image">
            </div>
            <div class="card-body">
        ...
        <div class="col-lg-4 my-5">
          <div class="card">
            <div class="col-5 position-absolute" style="top:-50px">
              <img src="./image/t.jpeg" alt="" class="mw-100 border rounded-circle">
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 pr-5">
            ...
            <img src="./image/s.jpg" alt="" class="img-fluid rounded">
          </div>
          <div class="col-lg-6 my-auto">
            <div class="row">
      ...
      <div class="row">
        <div class="col-6">
          ...
          <div class="text-center mt-n2">
            <img src="./image/placeholder.jpg" alt="" class="rounded-circle border" width="100" height="100">
